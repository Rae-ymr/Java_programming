...
public class Translator {
    ...
    Translator(String filename) throws Exception {
        ...
        if (match.find()) {
            ...
            throw new IllegalArgumentException(filename + " is not a valid language request");
        }

    }

    public void importTranslation() throws Exception {
        String fname = this.FN + ".ser";
    ...
    public void deserialize() throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            record = (TranslationText) in.readObject();
        } finally {
            if (in != null) {
                in.close();
            }
        }
        this.translation = record;
    ...
    public void serialize() throws Exception {
        ...
        public String translate( int month, int day, int year)throws Exception {


            if (month < 1 || month > 12) {
                throw new IllegalArgumentException(month + " is not a valid month number");
            } else {
                month--;
            }

            if (day < 1 || day > 31) {
                throw new IllegalArgumentException(day + " is not a valid day number");
            } else {
                day--;
            }
            return String.format(translation.getSentence(), translation.getDay(day), translation.getMonth(month), year);

        }
        public void importFromText() throws Exception {
            String filename = this.FN + ".txt";
            ...
            if (name.exists()) {
                ...
                throw new ArgFileNotFoundException(filename);
            }
        }
